...
public class TextInputActivityPresenter {
    private static final String TAG = "TextInputActivityPresenter";
    private TextInputActivityView view;
    private CompositeDisposable compositeDisposable = new CompositeDisposable();
    private Repository repository = new Repository();


    public TextInputActivityPresenter(TextInputActivityView view) {
        this.view = view;
    }
